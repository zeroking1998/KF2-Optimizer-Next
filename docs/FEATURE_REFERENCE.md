...
| Distance Sleep | Permanently sleeps every currently eligible corpse in the user-sized pool from 1,500 units, or 1,100/750 units under scene or frame pressure; no second actor cap applies | Matching actor ID and `state=sleep` receipt |

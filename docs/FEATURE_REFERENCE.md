...
| Distance Sleep | Permanently sleeps every currently eligible corpse in the user-sized pool from 1,200 units. A monotonic 0-100 score from visible enemies, total living enemies and active attacks continuously moves the threshold toward 450 units; corpse/frame levels provide the 800/450 tiers and no second actor cap applies | Matching actor ID and `state=sleep` receipt plus corpse/enemy/frame pressure levels |

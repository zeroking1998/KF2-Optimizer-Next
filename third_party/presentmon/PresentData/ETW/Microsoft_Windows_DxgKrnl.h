...
//     parameters: --no_event_structs --event=AdapterAllocation::Start --event=AdapterAllocation::Stop --event=AdapterAllocation::DCStart --event=Blit::Info --event=BlitCancel::Info --event=Flip::Info --event=FlipMultiPlaneOverlay::Info --event=IndependentFlip::Info --event=HSyncDPCMultiPlane::Info --event=VSyncDPCMultiPlane::Info --event=MMIOFlip::Info --event=MMIOFlipMultiPlaneOverlay::Info --event=MMIOFlipMultiPlaneOverlay3::Info --event=Present::Info --event=PresentHistory::Start --event=PresentHistory::Info --event=PresentHistoryDetailed::Start --event=QueuePacket::Start --event=QueuePacket::Start_2 --event=QueuePacket::Stop --event=VSyncDPC::Info --event=Context::DCStart --event=Context::Start --event=Context::Stop --event=HwQueue::DCStart --event=HwQueue::Start --event=NodeMetadata::Info --event=Device::DCStart --event=Device::Start --event=Device::Stop --event=DmaPacket::Start --event=DmaPacket::Info --provider=Microsoft-Windows-DxgKrnl
#pragma once
...
EVENT_DESCRIPTOR_DECL(BlitCancel_Info                , 0x01f5, 0x00, 0x11, 0x04, 0x00, 0x0135, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(Blit_Info                      , 0x00a6, 0x00, 0x11, 0x04, 0x00, 0x0067, 0x4000000008000001);
...
EVENT_DESCRIPTOR_DECL(Device_DCStart                 , 0x001d, 0x02, 0x11, 0x00, 0x03, 0x0013, 0x4000000000000840);
EVENT_DESCRIPTOR_DECL(Device_Start                   , 0x001b, 0x02, 0x11, 0x00, 0x01, 0x0013, 0x4000000000000840);
EVENT_DESCRIPTOR_DECL(Device_Stop                    , 0x001c, 0x02, 0x11, 0x00, 0x02, 0x0013, 0x4000000000000840);
EVENT_DESCRIPTOR_DECL(DmaPacket_Info                 , 0x00b1, 0x01, 0x11, 0x00, 0x00, 0x0008, 0x4000000000000001);
EVENT_DESCRIPTOR_DECL(DmaPacket_Info_2               , 0x01c2, 0x00, 0x11, 0x00, 0x00, 0x0008, 0x4000000000000001);
EVENT_DESCRIPTOR_DECL(DmaPacket_Info_3               , 0x01c3, 0x00, 0x11, 0x00, 0x00, 0x0008, 0x4000000000000001);
EVENT_DESCRIPTOR_DECL(DmaPacket_Start                , 0x00af, 0x01, 0x11, 0x00, 0x01, 0x0008, 0x4000000000000001);
EVENT_DESCRIPTOR_DECL(FlipMultiPlaneOverlay_Info     , 0x00fc, 0x00, 0x11, 0x00, 0x00, 0x008f, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(Flip_Info                      , 0x00a8, 0x00, 0x11, 0x00, 0x00, 0x0003, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(HSyncDPCMultiPlane_Info        , 0x017e, 0x02, 0x11, 0x00, 0x00, 0x00e6, 0x4000000008000001);
...
EVENT_DESCRIPTOR_DECL(MMIOFlipMultiPlaneOverlay3_Info, 0x0182, 0x08, 0x11, 0x00, 0x00, 0x00ea, 0x4000000000000001);
EVENT_DESCRIPTOR_DECL(MMIOFlipMultiPlaneOverlay_Info , 0x0103, 0x03, 0x11, 0x00, 0x00, 0x0090, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(MMIOFlip_Info                  , 0x0074, 0x00, 0x11, 0x00, 0x00, 0x0011, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(NodeMetadata_Info              , 0x00fa, 0x00, 0x11, 0x00, 0x00, 0x008d, 0x4000000000000001);
EVENT_DESCRIPTOR_DECL(PresentHistoryDetailed_Start   , 0x00d7, 0x02, 0x11, 0x00, 0x01, 0x007e, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(PresentHistory_Info            , 0x00ac, 0x02, 0x11, 0x00, 0x00, 0x0006, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(PresentHistory_Start           , 0x00ab, 0x02, 0x11, 0x00, 0x01, 0x0006, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(Present_Info                   , 0x00b8, 0x01, 0x11, 0x00, 0x00, 0x006b, 0x4000000008000001);
...
EVENT_DESCRIPTOR_DECL(VSyncDPCMultiPlane_Info        , 0x0111, 0x04, 0x11, 0x00, 0x00, 0x009f, 0x4000000008000001);
EVENT_DESCRIPTOR_DECL(VSyncDPC_Info                  , 0x0011, 0x00, 0x11, 0x00, 0x00, 0x000b, 0x4000000008000001);
...
enum class SetVidPnSourceAddressInputFlags : uint32_t {
    FlipStereo = 1,
...
enum class SetVidPnSourceAddressOutputFlags : uint32_t {
    PrePresentNeeded = 1,

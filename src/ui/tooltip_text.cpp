...
constexpr TooltipEntry kTooltips[]{
    ...
    {"game-launch", L"Starts KF2 through the Optimizer and begins Adaptive monitoring for the selected FPS target. It never enables NVIDIA FleX."},
    {"header-launch", L"Starts KF2 through the Optimizer and begins Adaptive monitoring for the selected FPS target. It never enables NVIDIA FleX."},
    ...
    {"diagnostics-auto-repair", L"Downloads the official release matching this exact installed version and repairs only missing or damaged managed files after SHA-256 verification."},
    ...
    {"header-backup", L"Creates and verifies a local backup of KFEngine.ini, KFGame.ini, and KFSystemSettings.ini. KF2 must be closed."},
    {"optimizer-backup", L"Creates and verifies a local backup of KFEngine.ini, KFGame.ini, and KFSystemSettings.ini. KF2 must be closed."},
    ...
    {"header-restore", L"Restores the latest verified configuration backup from this session. KF2 must be closed."},
    {"optimizer-restore", L"Restores the latest verified configuration backup from this session. KF2 must be closed."},

    {"diagnostics-refresh", L"Refreshes local hardware and diagnostic status and summarizes recorded warnings and errors. It does not change KF2."},
    {"dashboard-refresh", L"Refreshes local hardware and diagnostic status and summarizes recorded warnings and errors. It does not change KF2."},
    {"diagnostics-benchmark-baseline", L"Saves the current average FPS, 1% low, frame-time p95, and stutter count as the local comparison baseline."},
    {"diagnostics-benchmark-compare", L"Compares the current performance sample with the saved baseline and reports improvement, regression, or incompatible conditions."},
    {"diagnostics-clear", L"Clears the Optimizer's local diagnostic event history, then records that the clear action occurred."},
    {"diagnostics-export", L"Writes the current diagnostic report to the portable Data folder. Nothing is uploaded."},
    {"diagnostics-export-inventory", L"Writes the current feature inventory to the portable Data folder for auditing. Nothing is uploaded."},
    ...
    {"diagnostics-flex-audit", L"Checks the local NVIDIA FleX files and runtime evidence and reports what is available. It does not enable FleX."},
    ...
    {"settings-target-down", L"Lowers the saved Adaptive FPS target by one frame per second."},
    {"settings-target-up", L"Raises the saved Adaptive FPS target by one frame per second."},
    ...
    {"settings-corpses-down", L"Lowers the saved maximum corpse ceiling by one."},
    {"settings-corpses-up", L"Raises the saved maximum corpse ceiling by one."},
    {"settings-adaptive-aggressiveness", L"Cycles how quickly Adaptive reacts to confirmed pressure: conservative, balanced, or aggressive."},
    {"settings-adaptive-budget", L"Cycles the maximum number of bounded quality changes Adaptive may request in one decision."},
    {"settings-adaptive-calibration", L"Turns Adaptive calibration on or off. Calibration uses fresh telemetry to refine decisions without bypassing safety checks."},
    {"settings-adaptive-emergency", L"Allows emergency quality reductions only when severe, confirmed performance pressure crosses the safety threshold."},
    {"settings-adaptive-headroom-down", L"Reduces the extra performance headroom Adaptive keeps above the selected FPS target by one percentage point."},
    {"settings-adaptive-headroom-up", L"Increases the extra performance headroom Adaptive keeps above the selected FPS target by one percentage point."},
    {"settings-adaptive-locks", L"When enabled, user-locked capabilities cannot be changed by Adaptive. When disabled, Adaptive may use every currently available capability."},
    {"settings-adaptive-logging", L"Turns detailed local Adaptive decision logging on or off. No log is uploaded automatically."},
    {"settings-adaptive-maximum-down", L"Lowers the highest quality level Adaptive is allowed to select by five points."},
    {"settings-adaptive-maximum-up", L"Raises the highest quality level Adaptive is allowed to select by five points."},
    {"settings-adaptive-minimum-down", L"Lowers the quality floor Adaptive must preserve by five points."},
    {"settings-adaptive-minimum-up", L"Raises the quality floor Adaptive must preserve by five points."},
    {"settings-adaptive-recovery", L"Allows Adaptive to restore quality gradually after stable performance headroom is confirmed."},
    {"settings-adaptive-shadow", L"Turns observation-only Shadow mode on or off. Shadow mode records decisions but does not apply them."},
    {"settings-adaptive-headroom-slider", L"Sets the extra performance margin Adaptive keeps above the FPS target before it considers restoring quality."},
    {"settings-adaptive-maximum-slider", L"Sets the highest quality level Adaptive may use; it cannot exceed this limit."},
    {"settings-adaptive-minimum-slider", L"Sets the lowest quality level Adaptive may use; it cannot reduce quality below this floor."},
    ...
    {"overlay-scale-down", L"Reduces the saved overlay size by five percentage points."},
    {"overlay-scale-up", L"Increases the saved overlay size by five percentage points."},

...
constexpr std::array area01_items{
    ...
    ItemSpec{FeatureStatus::present, "installation, repair, update, and migration", "The portable package replaces only manifest-owned files, preserves user Data byte-for-byte, verifies fourteen managed payload hashes and falls back to Safe Mode with a re-extraction repair path when damaged."},
